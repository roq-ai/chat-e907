...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'admin'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_made.create': { roles: ['owner', 'admin'], key: 'payment_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'admin'], key: 'inventory_id', tenantPath: [], userPath: [] },
};
